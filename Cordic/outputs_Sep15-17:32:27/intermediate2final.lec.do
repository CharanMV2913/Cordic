...
# Generated on: Fri Sep 15 17:35:06 IST 2023 (Fri Sep 15 12:05:06 UTC 2023)
...
set_log_file logs_Sep15-17:32:27/intermediate2final.lec.log -replace

usage -auto -elapse

set_verification_information fv_map_Cordic_mv_db

read_implementation_information fv/Cordic -golden fv_map -revised Cordic_mv
...
read_design -verilog95   -golden -lastmod -noelab fv/Cordic/fv_map.v.gz
elaborate_design -golden -root {Cordic}

read_design -verilog95   -revised -lastmod -noelab outputs_Sep15-17:32:27/Cordic_m.v
elaborate_design -revised -root {Cordic}

#add_name_alias fv/Cordic/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/Cordic/Cordic_mv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Sep15-17:32:27/intermediate2final.lec.log
}
